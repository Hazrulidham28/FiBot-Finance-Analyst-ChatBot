...
VECTOR_DB_FOLDER = "local_vector_db"
...
st.title("FiBot: Financial AI Assistant")
...
if selected_vector_db == "Upload New Document":
    ...
    if uploaded_file:
        ...
        if st.button("Process PDF and Store in Vector DB"):
            with st.spinner("Processing document..."):
                ...
                embeddings = OllamaEmbeddings(model='nomic-embed-text', base_url="http://localhost:11437")
    ...
    if vector_db_path.exists():
        #http://host.docker.internal:11437 when using docker
        #http://localhost:11437 when using local
        embeddings = OllamaEmbeddings(model='nomic-embed-text', base_url="http://localhost:11437")
